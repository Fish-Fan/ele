    ...
    <div class="menu-wrapper" ref="menuWrapper">
      <ul>
        <li v-for="(item,index) in goods" @click="menuClick(index,$event)" :class="index==menuCurrentIndex?'menu-item-selected':'menu-item'">
          <span class="text">
            <iconMap v-show="item.type" :iconType="item.type"></iconMap>
            {{item.name}}
          </span>
        </li>
      </ul>
    ...
    <div class="foods-wrapper" id="wrapper" ref="foodsWrapper">
      <ul>
        <li v-for="item in goods" class="food-list food-list-hook">
          <h1>{{item.name}}</h1>
          <ul>
            <li v-for="food in item.foodList" class="food-item" @click="goDetail(food)">
              <div class="icon">
              ...
              <div class="content">
                ...
                <div class="sell-info">
                  <span class="sellCount">月售{{food.monthlyCounts}}份</span>
                  <span class="rating">好评率{{food.grade}}%</span>
                </div>
                <div class="price">
